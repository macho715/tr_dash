...
const CASES: SmokeCase[] = [
  ...
  { id: "KO-06a", query: "왜 이 활동이 지연돼?", expectedIntents: ["explain_why"] },
  { id: "EN-06a", query: "Why is this activity delayed?", expectedIntents: ["explain_why"] },
  { id: "EN-06b", query: "Where is TR-3 now?", expectedIntents: ["navigate_query"] },
  { id: "KO-06b", query: "Voyage 3 로드아웃 언제 시작해?", expectedIntents: ["navigate_query"] },
