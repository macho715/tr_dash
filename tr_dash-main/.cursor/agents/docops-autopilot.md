...
> **공통 규칙**: [_shared/common-rules.md](./_shared/common-rules.md) 참조 (문서 일관성 §11 포함)

## 목표
1. **최신 작업 반영** (가장 중요): 각 서류마다 본문 내용 + 메타(날짜/Refs) 최신화
2. SSOT 기반 문서 재정렬 + REF 일관성 (README/LAYOUT/SYSTEM_ARCHITECTURE/WORK_LOG 상호 Ref)
...
- **대상**: patch.md, AGENTS.md, README.md, docs/LAYOUT.md, docs/SYSTEM_ARCHITECTURE.md, docs/INDEX.md, docs/WORK_LOG_*.md, docs/guides/*
- **규칙**: 본문 내용 + 메타(날짜/Refs) 최신화. common-rules §11·docops-latest-work.md 준수.
