...
**Contract**: option_c.json. 검증은 tests/fixtures/option_c_baseline.json 기준(v0.8.0 스키마 참고). 운영 SSOT는 AGI 형식 유지(Contract v0.8.0 마이그레이션 보류).
...
| **Test** | PASS | 170 tests (실행 환경에 따라 167 등 상이할 수 있음), 23 files |
...
- **Exit**: 0
- **Result**: 170 tests (실행 환경에 따라 167 등 상이할 수 있음), 23 test files
