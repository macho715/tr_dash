...
**참고**: 실제 통합 적용은 tr-dashboard-plan.md Task 1~12 기준으로 수행됨.
...
**실제 구현 경로**: Gantt 렌더러는 `components/gantt/VisTimelineGantt.tsx`, 매퍼는 `lib/gantt/visTimelineMapper.ts`. Task 3~8의 파일 경로는 위 구현을 기준으로 참고.
